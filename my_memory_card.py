...
class Question():
    def __init__(self, question, right_answer, wrong1, wrong2, wrong3):
        ...
        self.wrong3 = wrong3
questions_list = []
questions_list.append(Question('где находится статуя свободы?', 'Нью йорк', 'Англия', 'Испания', 'Бразилия'))
questions_list.append(Question('в какой игре присутствует строительство?', 'fortnite', 'GTA5', 'PUBG', 'Geometry Dash'))
